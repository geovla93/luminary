  ...
  return (
    <>
      <View style={[DEFAULT.Styles.reset?.header, styles?.header]}>
        <Text style={[DEFAULT.Styles.reset?.title, styles?.title]}>
          {textOptions?.title}
        </Text>
        <Text style={[DEFAULT.Styles.reset?.subTitle, styles?.subTitle]}>
      ...
      <View style={DEFAULT.Styles.reset?.content}>
        {status == PinCodeT.Statuses.Initial && (
          <>
            <Pressable
              ...
              <Text
                style={[
                  DEFAULT.Styles.reset?.resetButton,
                  styles?.resetButton,
                ]}>
                {textOptions?.resetButton}
              </Text>
            </Pressable>
          </>
        )}
        {status == PinCodeT.Statuses.ResetPrompted && (
          <>
            <Text style={[DEFAULT.Styles.reset?.confirmText]}>
              {textOptions?.confirm}
            </Text>
            <Pressable
              onPress={onReset}
      ...
      <View style={styles?.footer}>
        <Text
          onPress={onCancel}
          style={[DEFAULT.Styles.reset?.footerText, styles?.footerText]}>
